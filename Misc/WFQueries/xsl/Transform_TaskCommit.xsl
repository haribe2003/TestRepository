...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="updateTaskOutcome" namespace="http://xmlns.oracle.com/bpel/workflow/taskService"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [SUN NOV 15 07:49:07 EST 2015]. -->
?>
