...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="acquireTasks" namespace="http://xmlns.oracle.com/bpel/workflow/taskService"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [SUN NOV 15 08:07:36 EST 2015]. -->
?>
